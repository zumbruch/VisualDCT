...
/**
 * <code>ArchiverEditorComponent</code> doesn't allow duplicate group names and all
 * properties' values have to be numbers.
 *
					...
					if (e.getKeyCode() == 10) {
						if (element instanceof Group) {
							...
							if (!text.equals(element.getName())) {
								if (!((ArchiverTree)tree).isGroupNameUnique(text)) {
									JOptionPane.showMessageDialog(tree,
									    "Group named " + text
